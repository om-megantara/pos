...
<section class="content">
    <div class="container-fluid">
        <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <a href="<?=base_url('transaction/purchase')?> ">
                    <button type="submit" class="btn btn-primary" data-toggle="modal" data-target="#add_product"
                        data-dismiss="modal"><i class="fas fa-sm fa-plus"></i> Add Purchase
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th width="12%" style="text-align:center;vertical-align:middle;padding:0.2rem;">PO Number
                            </th>
                            <th width="35%" style="text-align:center;vertical-align:middle;padding:0.2rem;">Supplier
                                Name
                            </th>
                            <th width="10%" style="text-align:center;vertical-align:middle;padding:0.2rem;">Total Item
                            </th>
                            <th width="20%" style="text-align:center;vertical-align:middle;padding:0.2rem;">Total</th>
                            <th width="15%" style="text-align:center;vertical-align:middle;padding:0.2rem;"></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style='padding:0.2rem;text-align:center;'><?= htmlentities($p->Item, ENT_QUOTES);?></td>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <!-- <form method="POST" enctype="multipart/form-data"
                                                        action="<?= base_url('master/save_product/'.htmlentities($p->POID, ENT_QUOTES));?>"> -->
                                                <!-- <?php csrf_field(); ?> -->
                                                <!-- <div class=""> -->
