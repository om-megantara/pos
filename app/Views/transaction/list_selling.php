                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th width="19%" style="text-align:center;vertical-align:middle;padding:0.2rem;">Customer
                                Name
                            </th>
                            <th width="12%" style="text-align:center;vertical-align:middle;padding:0.2rem;">Total Item
                            </th>
                            <th width="12%" style="text-align:center;vertical-align:middle;padding:0.2rem;">Discount
                            </th>
                            <th width="10%" style="text-align:center;vertical-align:middle;padding:0.2rem;">Total</th>
