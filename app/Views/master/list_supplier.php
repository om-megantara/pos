...
<section class="content">
    <div class="container-fluid">
        <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <button type="submit" class="btn btn-primary" data-toggle="modal" data-target="#add_supplier"
                    data-dismiss="modal"><i class="fas fa-sm fa-plus"></i> Add Supplier</button>
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th width="8%" style="text-align:center;vertical-align:middle;padding:0.2rem;">supplier ID
                            </th>
                            <th width="19%" style="text-align:center;vertical-align:middle;padding:0.2rem;">Supplier
                                Name
                            </th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style='padding:0.2rem;'><?= htmlentities(strtoupper($p->SupplierID), ENT_QUOTES);?></td>
                            <td style='padding:0.2rem;'><?= htmlentities(strtoupper($p->SupplierName), ENT_QUOTES);?>
                            </td>
                            ...
                            <td style='padding:0.2rem;text-align:center;'>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="POST" enctype="multipart/form-data"
                                                    action="<?= base_url('master/save_supplier/'.htmlentities($p->SupplierID, ENT_QUOTES));?>">
                                                    <?php csrf_field(); ?>
                                                    <div class="row">
                                                        <div class="form-group col-sm-6" style="text-align:left">
                                                            <label>Supplier Name</label>
                                                            <input type="text" name="supplier_name" id="supplier_name"
                                                                value="<?= htmlentities(strtoupper($p->SupplierName), ENT_QUOTES);?>"
                                ...
                                <a href="<?= base_url('master/delete-supplier/'.$p->SupplierID); ?>">
...
<div class="modal fade" id="add_supplier" tabindex="-1" role="dialog" aria-labelledby="add_supplier" aria-hidden="true">
    <div class="modal-dialog  modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title" id="add_supplier">Add Supplier</h2>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form method="POST" enctype="multipart/form-data" action="<?= base_url('master/save-supplier')?>">
                    <?php csrf_field(); ?>
                    <div class="row">
