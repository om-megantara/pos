                        ...
                        <div class="col-lg">
                            <div class="p-5">
                                <div class="text-center">
                                    ...
                                    ?>
                                    <img src="<?= base_url('public/img/'.$logo); ?>" alt="<?= $nama;?>"
                                        style="text-align: center;max-height:75px;max-width:75px;" class="my-2">
                                ...
                                <form class="user" action="<?= url_to('login') ?>" method="post">
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox small">
                                            <label class="custom-control-label" for="customCheck"><input type="checkbox"
                                                    id="remember" class="custom-control-input"
                                    ...
                                    <button type="submit"
                                        class="btn btn-primary btn-user btn-block"><?=lang('Auth.loginAction')?>
                                    </button>
                                </form>
                                <hr>
